# Leverage Flux and Kustomize to manage multiple clusters while minimizing duplicated declarations.

* Custom resources:
  HelmRepository
  HelmRelease

* Flux to install, test and upgrade a demo app

* Weave GitOps (an OSS UI for Flux) to visualise and monitor the workloads managed by Flux.
